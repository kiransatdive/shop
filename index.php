...
{$u=$_POST['RollNo'];
 ...
 $sql="select * from shop.user where RollNo='$u'";
...
if(strcasecmp($x,$p)==0 && !empty($u) && !empty($p))
  ...
  if($y=='Admin')
   header('location:admin/admin.php');
  	...
  	header('location:users/order.php');
...
if(isset($_POST['signup']))
{
	...
	$sql="insert into shop.user (Name,Type,RollNo,EmailId,MobNo,Password) values ('$name','$type','$rollno','$email','$mobno','$password')";
